...
Write-Host "Checking for updates (Heavy)..." -ForegroundColor Cyan

$apiUrl = "https://api.github.com/repos/GRILLYje/Fishing_Heavy_public/releases/latest"
...
Write-Host "Launching Heavy..." -ForegroundColor Green
